...
mkpath="E:/fengfa_zengqiang_nengliang/ban"

# 调用函数
mkdir(mkpath)

mkpath="E:/fengfa_zengqiang_nengliang/guanbi"

# 调用函数
mkdir(mkpath)


mkpath="E:/fengfa_zengqiang_nengliang/kai"
...
mkpath="E:/fengfa_zengqiang_nengliang1"
...
def read_path(file_pathname):
    ...
    for filename in os.listdir(file_pathname):
      ...
      #（下面第一行是将RGB转成单通道灰度图，第二步是将单通道灰度图转成3通道灰度图）
        ...
        #####save figure
        cv2.imwrite('E:/fengfa_zengqiang_nengliang/ban'+"/"+filename,frame_out)       
...
def read_path1(file_pathname):
    ...
    for filename in os.listdir(file_pathname):
      ...
      #（下面第一行是将RGB转成单通道灰度图，第二步是将单通道灰度图转成3通道灰度图）
        ...
        #####save figure
        cv2.imwrite('E:/fengfa_zengqiang_nengliang/kai'+"/"+filename,frame_out)       
...
def read_path2(file_pathname):
    ...
    for filename in os.listdir(file_pathname):
      ...
      #（下面第一行是将RGB转成单通道灰度图，第二步是将单通道灰度图转成3通道灰度图）
        ...
        #####save figure
        cv2.imwrite('E:/fengfa_zengqiang_nengliang/guanbi'+"/"+filename,frame_out)       
